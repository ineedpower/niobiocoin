...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Niobiocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"niobiocointools.com", "186.216.193.70"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"niobiocointools.com", "testnet-seed.niobiocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Niobiocoin is probably already running."), addrBind.ToString().c_str());
        else
